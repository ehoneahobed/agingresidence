...
import FeaturedCommunitySkeletonCard from '../skeletons/featuredCommunitySkeleton';
...
const FeaturedCommunities: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Featured Senior Communities</title>
        <meta
          name="description"
          content="Discover the diversity of amenities, services, and pricing our certified communities offer to find your perfect match."
        />
      </Head>
            ...
            <div className="mt-10 text-center">
              {error ? (
                <p className="text-red-500 text-lg">
                  Unable to fetch listings at the moment. Please try again later.
                </p>
              ) : (
                <div className="mt-10 grid gap-6 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1">
                  {[...Array(6)].map((_, index) => (
                    <FeaturedCommunitySkeletonCard key={index} />
                  ))}
                </div>
              )}
            </div>
                        ...
                        <span className="inline-block align-middle">
                          ...
                          >
                            <path
                              ...
                              d="M15.232 13.232a3 3 0 01-4.264 0l-5-5a3 3 0 114.264-4.264l.768.768a2 2 0 002.828 0l.768-.768a3 3 0 014.264 4.264l-5 5z"
                            ></path>
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              d="M18 10.28V21a2 2 0 01-2 2H8a2 2 0 01-2-2v-10.72a4.002 4.002 0 015.272-5.272l.728.728a4 4 0 005.272 0l.728-.728A4.002 4.002 0 0118 10.28z"
                            ></path>
                          </svg>
                        </span>
                        {community.phone}
                        ...
                        <div className="flex items-center text-gray-600">
                          ...
                          >
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.68l-1.06-1.07a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.44l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78v0z"
                            ></path>
                          </svg>
                          {community.views}
                        </div>
