...
const allListings = [
    {
      ...
      popular: true,
      description: "Edelweiss Assisted Living offers a comfortable and secure environment for seniors.",
    },
    {
      ...
      image: "https://placehold.co/600x400",
      popular: true,
      description: "Golden Years Assisted Living provides personalized care and support for seniors.",
    },
    {
      slug: "glencroft-senior-living",
      ...
      image: "https://placehold.co/600x400",
      popular: true,
      description: "Glencroft Senior Living offers a vibrant community and comprehensive services.",
    },
    {
      slug: "tanner-terrace-apartments",
      ...
      image: "https://placehold.co/600x400",
      popular: true,
      description: "Tanner Terrace Apartments provide a friendly and safe environment for seniors.",
    },
    {
      slug: "glencroft-center-for-modern-aging",
      ...
      image: "https://placehold.co/600x400",
      popular: true,
      description: "Glencroft Center for Modern Aging offers innovative and comprehensive senior care.",
    },
    {
      slug: "holiday-westgate-village",
      ...
      image: "https://placehold.co/600x400",
      popular: true,
      description: "Holiday Westgate Village is a vibrant and welcoming senior community.",
    },
